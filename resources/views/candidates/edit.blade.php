        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('candidates.update', $candidate->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('visi_misi') is-invalid @enderror" name="visi_misi" rows="5" placeholder="Masukkan Konten Post">{{ old('visi_misi', $candidate->visi_misi) }}</textarea>
